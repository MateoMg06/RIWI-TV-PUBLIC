...
export interface IShowtimeRepository {
  ...
  findActiveByCinemaIds(cinemaIds: number[], startDate?: string, endDate?: string): Promise<Showtime[]>;
  findActiveByCityId(cityId: number, startDate?: string, endDate?: string): Promise<Showtime[]>;
